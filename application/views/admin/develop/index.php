<div id="content">
    ...
    <div class="box">
        ...
        <div class="content">
            <form id="form_list" method="post" action="<?= base_url(); ?>admin/develop">
                ...
                <table class="list">
                    <thead>
                        <tr>
                            ...
                            <td class="left"><a href="#">Subject</a></td>
                            <td class="left"><a href="#">Message</a></td>
                            <td class="left"><a href="#">Service</a></td>
                            <td class="left"><a href="#">File Upload</a></td>
                            <td class="left"><a href="#">Time</a></td>
