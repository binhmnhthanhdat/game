...
class parttent extends Admin_controller {
    ...
    public function index() {
        ...
        $data = array();
        $data['render_path'] = array('Admin' => base_url() . 'admin/trangchu ', 'Danh mục Khác' => base_url() . 'admin/parttent');
        $data['heading_title'] = 'Quản lý Khác';
    ...
    public function add_edit() {
        ...
        if ($_id != '')
            $data['article'] = $this->parttent->get_by_id($_id);
