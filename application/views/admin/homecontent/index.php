<div id="content">
    ...
    <div class="box">
        ...
        <div class="content">
            <form id="form_list" method="post" action="<?= base_url(); ?>admin/homecontent/index">
                ...
                <table class="list">
                    <thead>
                        <tr>
                            ...
                            <td class="right" ><a href="#">Url</a></td>
                            <td class="left" ><a href="#">Loại</a></td>
                            <td class="left" ><a href="#">Căn lề</a></td>
