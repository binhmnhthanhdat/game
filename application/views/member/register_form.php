                ...
                <table width="100%" border="0" cellspacing="5" cellpadding="0">
                    ...
                    <tr>
                        ...
                        <td align="left" valign="middle">
                            <input type="text" id="sercode" name="sercode" size="10" class="user_pass" value="<?= set_value('sercode'); ?>" onblur="if (this.value == '')
                                        this.value = 'Nhập mã bảo vệ';" onfocus="if (this.value == 'Nhập mã bảo vệ')
                                                    this.value = '';" /><br /><br>
                                   <?= $captcha; ?>
